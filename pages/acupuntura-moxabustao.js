...
const AcupunturaMoxa = () => {
  return (
    <>
      <Head>
        <title>Terapia - Acupuntura e Moxabustão</title>
        <meta
          name="description"
        ...
        <S.Container>
          ...
          <S.DescriptionContainer>
            <S.Article>
              ...
              <S.Text>
                Esta técnica é dos recursos mais conhecidos da Medicina Chinesa
                e desde 2010 que faz parte do Património cultural intagível da
                UNESCO. Os efeitos terapêuticos da acupunctura são conseguidos
                através da inserção e estimulação de agulhas extremamente finas
                em pontos específicos do corpo que regulam e restabelecem a
                circulação activando a homeostase a capacidade do corpo humano
                de auto-regulação. Os pontos estão agrupados num conjunto de
            ...
            <S.Article>
              ...
              <S.Text>
                ...
                combustão de uma planta, Artemísia Vulgaris. A Artemisia é
                tratada de forma a obter um algodão, que pode ser prensado em
                charutos ou moldado, para fazer bagos de arroz ou cones e
                estimular pontos específicos ou áreas do corpo, com o fim de
                restabelecer ou reforçar a circulação nos meridianos através dos
                seus efeitos anti-inflamatórios, analgésico e vaso-dilatador.
              </S.Text>
            </S.Article>
            <S.Article>
              ...
              <S.List>
                ...
                <li>
                  ...
                  ulceras sem complicações, obstipação, diarreia, dores de
                  dentes, gengivite e faringite.
                </li>
                <li>
